  ...
  return (
    <footer style={{ background: '#fff', color: '#27548A', textAlign: 'center', padding: 0, marginTop: 47, margin: 0, borderRadius: '0 0 10px 10px', fontWeight: 600, fontSize: 16, boxShadow: '0 -2px 12px #0001' }}>
      <div style={{ borderBottom: '1px solid #e0e0e0', padding: '36px 0 18px 0', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flex: 1, justifyContent: 'center', gap: 48, fontSize: 17, fontWeight: 600 }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minWidth: 180 }}>
            <div style={{ fontWeight: 700, color: '#27548A', marginBottom: 4 }}>Horários: Asa Sul</div>
            <div>Segunda-Sábado: 11:00 às 23:00</div>
            <div>Domingo: 11:00 às 16:00</div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minWidth: 180 }}>
            <div style={{ fontWeight: 700, color: '#27548A', marginBottom: 4 }}>Endereço</div>
            <div>Av. das Nações, 1234</div>
            <div>Asa Sul, Brasília - DF</div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minWidth: 180 }}>
            <div style={{ fontWeight: 700, color: '#27548A', marginBottom: 4 }}>Contato</div>
            <div>(61) 99999-8888</div>
            <div>(61) 98888-7777</div>
          </div>
        </div>
